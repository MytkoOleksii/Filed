...
const DialogItem: React.FC<PropsType> = (props) => {
    ...
    return (
        <div className={teg.dialog }>
            <NavLink className={teg.dialog2} to={'/dialog/' + props.id}>{img}{props.name}</NavLink>
        </div>
    )
}
